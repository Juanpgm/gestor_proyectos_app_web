          ...
          {showLayerControls && (
            <div className="flex items-center space-x-4">
              ...
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  type="checkbox"
                  checked={layerVisibility.unidadesProyecto}
                  onChange={() => toggleLayer('unidadesProyecto')}
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">Unidades de Proyecto</span>
              </label>
              ...
              <label className="flex items-center space-x-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">Infraestructura</span>
              </label>
            </div>
          )}
        </div>
